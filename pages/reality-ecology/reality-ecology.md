...
[Глава 9. Проблемы решения](#9)
[Глава 10. Что делать?](#10)
...
![Enter image alt description](Images/tN5_Image_1.gif)
...
![Enter image alt description](Images/v4M_Image_2.png)
...
![Enter image alt description](Images/RTe_Image_3.png)
...
![Enter image alt description](Images/vo0_Image_4.png)
...
![Enter image alt description](Images/Akk_Image_5.png)
...
![Enter image alt description](Images/fru_Image_6.png)
...
![Enter image alt description](Images/X7m_Image_7.png)
...
![Enter image alt description](Images/2EW_Image_8.png)
...
![Enter image alt description](Images/KHs_Image_9.png)
...
![Enter image alt description](Images/pod_Image_10.png)
...
![Enter image alt description](Images/Smc_Image_11.png)
...
![Enter image alt description](Images/CPY_Image_12.png)
...
![Enter image alt description](Images/bQR_Image_13.png)
...
![Enter image alt description](Images/wsb_Image_14.png)
...
![Enter image alt description](Images/46g_Image_15.png)

*Часть антирекламной кампании Greenpeace против Nestle:*

![Enter image alt description](Images/i5p_Image_16.png)
...
![Enter image alt description](Images/6JN_Image_17.png)
...
![Enter image alt description](Images/VK6_Image_18.png)

*Реклама 7up: Мамы знают что смешение молока и 7up полезно:*

![Enter image alt description](Images/EZn_Image_19.png)
...
![Enter image alt description](Images/RJ3_Image_20.png)

![Enter image alt description](Images/Mmq_Image_21.png)
...
![Enter image alt description](Images/Ds5_Image_22.png)
...
![Enter image alt description](Images/vIa_Image_25.png)

![Enter image alt description](Images/TPF_Image_26.png)
...
![Enter image alt description](Images/GyA_Image_27.png)
...
![Enter image alt description](Images/FGT_Image_28.png)

![Enter image alt description](Images/uTf_Image_29.png)
...
![Enter image alt description](Images/vf1_Image_30.png)
...
![Enter image alt description](Images/trM_Image_31.png)
...
![Enter image alt description](Images/jp3_Image_32.png)
...
![Enter image alt description](Images/u0C_Image_33.png)
...
![Enter image alt description](Images/5bs_Image_34.png)
...
![Enter image alt description](Images/mJ3_Image_35.png)
...
![Enter image alt description](Images/4jl_Image_36.png)
...
“**Целью всей моей жизни было уничтожение коммунизма**” Горбачев  – бывший генеральный секретарь Коммунистической партии Советского Союза. Речь на семинаре в Американском университете в Турции в 1999 году. [Видео подтверждения.](https://youtu.be/FGIQMv-Z04o?si=7FZ0QxgGy544Gigp)
...
По странному(нет) стечению обстоятельств именно те цели которые реализовала скурвившаяся элита СССР в отношении своей родины, были прописаны в управленческом концепции её врага холодной войны – Совета Национальной Безопасности США:
...
![Enter image alt description](Images/BiE_Image_37.png)
...
![Enter image alt description](Images/bkt_Image_38.png)

*Ознакомьтесь с оглавлением:*

![Enter image alt description](Images/a0R_Image_39.png)
...
\
[Ссылка: Приложение 1. Достаточно Общая Теория Управления](https://temniyecolog.ru/application1)
...
Эта записка альтернатива книге “Лестница в небо” экономиста Михаила Леонидовича  Хазина.

[Ссылка: Приложение 2. Об этике и её роли в жизни](https://dotu.ru/2019/04/02/20190402_about_ethics/)

#  \
Глава 11. Философия – наука о предсказуемости вариантов будущего
...
По своей сути для сдачи предмета достаточно изучить историческую биографию деятелей называющих себя философами и вкратце их идеи. Никаких задач по применению философского рычага методологии для поворота Земли на место экзамен не предусматривает. В результате чего отношение к этому предмету не вполне серьезное, а методология иногда вообще описывается анекдотами про Петьку и Василия Ивановича.
...
![Enter image alt description](Images/GQy_Image_40.png)
...
Иначе получается как в известном рассказе “Автостопом по галактике”. Когда люди 1000 лет ждали пока ~~философ~~ компьютер думает ответ на вопрос: **“В чём смысл жизни и всё такое?” **В итоге он выдал: 42.

![Enter image alt description](Images/s65_Image_41.png)
...
Наука логики говорит нам о том, что доказательства или опровержения существования Высшего разума не существует. Теорема Гёделя о неполноте: **в любой системе знаний есть недоказуемые утверждения, которые нельзя доказать или опровергнуть не выйдя за рамки этой системы.**

Так-как наука не обладает такой “палкой”, которой можно было бы пощупать Надмирную реальность и её обитателей, вопросы **во что верить или не верить, лежат вне её компетенции**.
...
И не так важно, к какому выводу вы придете в вопросе выбора Верхнего ограничителя: Высший разум, непознаваемые законы природы или большой взрыв, важно, на познание каких объективных закономерностей это нас подтолкнет.

![Enter image alt description](Images/NsP_Image_42.png)

Ведь одно известно точно, — не соблюдение условий эксплуатации системы приведет её к краху. \
\
В пример можно привести творчество писателя-философа-фантаста Станислава Лема, в частности книгу “Сумма Технологий”, одно из повествований которой идет о парадоксе Ферми, суть которого в том, что мы должны видеть в Космосе множество цивилизаций, но не видим ни кого. И ответ на вопрос “почему”, может быть довольно бичующим:
...
«*Теперь, когда мы научились летать по воздуху, как птицы, плавать под водой, как рыбы, нам  осталось научиться жить на Земле, по-человечески*». Бернар Шоу

Расширенный сборник, который охватывает все поднимаемые вопросы и умолчания не озвученные в кусре: [Основы социологии](https://dotu.ru/2016/12/24/20161224-bases-of-sociology_red2016/20161224_Bases-of-Sociology.T1_red2016.pdf)

![Enter image alt description](Images/qH8_Image_43.png)
